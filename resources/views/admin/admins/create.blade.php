...
@section('content')
	{{ Form::open(array('url' => array('/admin/admins/create'), 'class' => 'form-horizontal', 'id' => 'useradd', 'files' => 'true', )) }}
		@if(count($errors) > 0)
		...
		<div class="box administrateurs">
			<div class="box-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						{{ Form::password('password_confirmation', array('required' => '', 'class' => 'form-control', 'id' => 'password_confirmation', 'placeholder' => trans('messages.Password'))) }}
					</div>
				</div>
				<div class="form-group">
...
@section('content_header')
	<h1><i class="fa fa-user-circle-o"></i> {{trans('messages.ManagementAdministrators')}} <small>{{trans('messages.CreateAdministrator')}} </small></h1>
	<ol class="breadcrumb">
