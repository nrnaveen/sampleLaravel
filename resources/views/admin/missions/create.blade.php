...
@section('content')
	{{ Form::open(['url' => '/admin/missions/create', 'novalidate' => 'novalidate', 'id' => 'updatePenalty', 'class' => 'form-horizontal']) }}
		@if (count($errors) > 0)
...
@section('content_header')
	<h1>{{trans('messages.AddMission')}}<small>{{trans('messages.NewMission')}}</small></h1>
	<ol class="breadcrumb">
