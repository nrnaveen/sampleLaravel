...
@section('content')
	{{ Form::open(['url' => '/admin/absence-types/add', 'novalidate' => 'novalidate', 'id' => 'updatePenalty', 'class' => 'form-horizontal']) }}
		@if (count($errors) > 0)
...
@section('content_header')
	<h1>{{trans('messages.AddAbsenceType')}}<small>{{trans('messages.NewAbsenceType')}}</small></h1>
	<ol class="breadcrumb">
