...
@section('content')
	{{ Form::model($event, array('url' => array('/admin/events/edit/' . $event->id), 'novalidate' => 'novalidate', 'id' => 'updateAbsence', 'class' => 'form-horizontal',)) }}
		@if (count($errors) > 0)
...
@section('content_header')
	<h1>{{trans('messages.EditEvent')}}<small>{{trans('messages.ModifyEventDetails')}}</small></h1>
	<ol class="breadcrumb">
